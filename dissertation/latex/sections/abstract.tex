\begin{abstract}
  ...
  Resources can be encrypted with unique, fine-grained policies of attributes that must then be resolved by an end user's private key to complete decryption.
  \vskip 0.5em
