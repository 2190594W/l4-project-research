...
\Cref{fig:appendix_enc_upl} represents a encryption \& upload sequence diagram for a user in the \theResServer system.
...
\Cref{fig:appendix_dow_dec} represents a encryption \& upload sequence diagram for a user in the \theResServer system.
