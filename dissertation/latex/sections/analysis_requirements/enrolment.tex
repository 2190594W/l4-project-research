...
Following from \Cref{subsec:analysis_deployment_mks} and \Cref{subsec:analysis_deployment_iuk}, a \acrfull{dcs} user must be able to enrol in the \theResServer system by physically visiting the Teaching Office and proving their identity to the Admin staff, shown in \Cref{fig:deployment_diagram}. Staff and students could prove their identity with their respective campus ID cards, with passports providing further evidence should the Admin staff require it.
