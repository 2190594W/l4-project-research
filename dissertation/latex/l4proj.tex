...
Evaluation of the project is presented in the form of a risk assessment, verifying the security of the project and a discussion of the project achievements, with reference to the functionality validation that the Case Studies designed in \Cref{sec:analysis_case_studies} provide.
