...
def download_file(file_id):
    ...
    """
    res_server_res = requests.get(f'http://{RES_SERVER}/download/{file_id}')
...
@APP.route('/download_decrypt/<file_id>', methods=['GET', 'POST'])
def download_decrypt_file(file_id):
    ...
    """
    res_server_res = requests.get(f'http://{RES_SERVER}/file_meta/{file_id}')
